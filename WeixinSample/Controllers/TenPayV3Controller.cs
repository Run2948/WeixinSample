...
using WeixinSample.CommonService.TemplateMessage;
using Senparc.Weixin.TenPay.V3;
using WeixinSample.Filters;
using WeixinSample.Models;
using ZXing;
using ZXing.Common;
//DPBMARK MP
//DPBMARK_END
    ...
    public class TenPayV3Controller : Controller
    {
        ...
        public ActionResult JsApi(int productId, int hc)
        {
            try
            {
                ...
                var xmlDataInfo = new TenPayV3UnifiedorderRequestData(TenPayV3Info.AppId, TenPayV3Info.MchId, body, sp_billno, price, Request.UserHostAddress, TenPayV3Info.TenPayV3Notify, Senparc.Weixin.TenPay.TenPayV3Type.JSAPI, openId, TenPayV3Info.Key, nonceStr);
        ...
        public ActionResult NativeNotifyUrl()
        {
            ...
            var xmlDataInfo = new TenPayV3UnifiedorderRequestData(TenPayV3Info.AppId, TenPayV3Info.MchId, "test", sp_billno, 1, Request.UserHostAddress, TenPayV3Info.TenPayV3Notify, Senparc.Weixin.TenPay.TenPayV3Type.JSAPI, openId, TenPayV3Info.Key, nonceStr);
        ...
        public ActionResult NativeByCodeUrl()
        {
           ...
           Senparc.Weixin.TenPay.TenPayV3Type.NATIVE,
            null,
            TenPayV3Info.Key,
            nonceStr,
            productId: productId);
...
#else
            var result = TenPayV3.MicroPay(new TenPayV3MicroPayRequestData(
                TenPayV3Info.AppId,
                TenPayV3Info.MchId,
                TenPayV3Info.Key,
                ...
                "detail",
                "attach",
                SystemTime.Now.ToString("HHmmss") + TenPayV3Util.BuildRandomStr(26),
                "1",
                "",
                Request.UserHostAddress,
                "",
        ...
        {
            {
                try
                {
                    ...
                    var xmlDataInfo = new TenPayV3UnifiedorderRequestData(TenPayV3Info.AppId, TenPayV3Info.MchId, body, sp_billno, price, Request.UserHostAddress, TenPayV3Info.TenPayV3Notify, Senparc.Weixin.TenPay.TenPayV3Type.MWEB/*此处无论传什么，方法内部都会强制变为MWEB*/, openId, TenPayV3Info.Key, nonceStr);
